...
- `/mn-review` - Performs thorough code reviews as a project maintainer. Accepts a PR number or URL, or reviews local worktree changes when no arguments provided. Covers code quality, security, performance, testing, and documentation.
